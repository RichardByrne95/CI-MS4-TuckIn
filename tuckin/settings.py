'''
Django settings for tuckin project.
...
ALLOWED_HOSTS = ['https://tuckin-ms4.herokuapp.com/', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'tuckin.wsgi.application'
