...
class Order(models.Model):
    ...
    order_restaurant = models.ForeignKey(
        Restaurant, max_length=128, null=False, blank=False, on_delete=RESTRICT, related_name='orders')
    customer_profile = models.ForeignKey(
        CustomerProfile, on_delete=models.SET_NULL, null=True, blank=False, related_name='orders')
...
class OrderLineItem(models.Model):
    order = models.ForeignKey(
        Order, null=False, blank=False, on_delete=CASCADE, related_name='lineitems')
    food_item = models.ForeignKey(
        FoodItem, null=False, blank=False, on_delete=RESTRICT)
